...
ResearchWorkPreprocessingAlmazovRazdel - a file with pre-processing of the main text field with general recommendations from the doctor into single sentences using Natasha Razdel.
